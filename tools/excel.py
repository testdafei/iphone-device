...
from tools.extlib import xlsxwriter
...
if __name__ == '__main__':
    ...
    # excel.csv_to_xlsx("/Users/admin/PycharmProject/mobileperf/results/com.kmxs.reader/2022_07_04_09_59_29/cpuinfo.csv",
    #                   "pid_cpu","datetime","%",["pid_cpu%","total_pid_cpu%"])
    # excel.csv_to_xlsx("/Users/admin/PycharmProjects/taobao-iphone-device/results/com.kmxs.reader/2022-07-04 12-43-32/cpuinfo.csv",
    #                   "device_cpu_rate", "timestamp", "%", ["device_cpu_rate","system_cpu_rate"])
    excel.csv_to_xlsx("/Users/admin/PycharmProjects/taobao-iphone-device/results/com.yueyou.cyreader/2022_07_12_19_40_14/cpuinfo.csv",
                      "device_cpu_rate", "timestamp", "%", ["device_cpu_rate","system_cpu_rate"])
    excel.save()
